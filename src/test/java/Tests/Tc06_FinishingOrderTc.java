...
public class Tc06_FinishingOrderTc {
    ...
    @Test
    public void checkForFinishingOrderTc() throws IOException {
        ...
        new P04_CheckOutPage(getDriver())
                ...
                .clickOnContinue();
        //ToDo:Going To Finishing Page
        new P05_PaymentPage(getDriver()).clickOnFinishBtn();
        Assert.assertTrue(new P06_FinishingPage(getDriver()).CheckVisibilityOfFinishingMsg());
    }
